...
?>
<br class="clear" />
<input type="button" name="back" value="Repair Tables" class="button" onclick="return clean_tables('<?=$_SERVER['REQUEST_URI'];?>?id=clean_tables');" >
...
<form action="<?=$_SERVER['PHP_SELF'];?>?id=change_salt" method="post">
	<input type="text" name="code" value="<?=md5(rand(0,255));?>" /> <?=_ROOT;?>
</form>
<form action="<?=$_SERVER['PHP_SELF'];?>?id=change_email" method="post">
  <b>Particular</b><br />
	User : <input type="text" name="username" value="<?=$usr['username'];?>" readonly /><br />
	Email : <input type="text" name="email" value="<?=$usr['email'];?>" /><br />
	Domain : <input type="text" name="url" value="<?=$site['url'];?>" /><br />
	Email Name : <input type="text" name="eml[name]" value="<?=$eml['name'];?>" /><br />
	Email Address : <input type="text" name="eml[address]" value="<?=$eml['address'];?>" /><br />
	Email Subject : <input type="text" name="eml[subject]" value="<?=$eml['subject'];?>" /><br />
